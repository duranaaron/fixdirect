...
import { Clock, CheckCircle, Wallet, Calendar as CalendarIcon, List, Check, Wallet2, LucideWallet, BadgeEuro, Gem } from 'lucide-react';
            ...
            <div className="flex flex-col gap-8 p-6 md:p-8">
                ...
                <div className="flex flex-col justify-between gap-4 md:flex-row md:items-end">
                    <div>
                        ...
                        <p className="text-muted-foreground">Beheer jouw bevestigde klusjes en agenda</p>
                    </div>
                ...
                <div className="rounded-xl border border-sidebar-border/70 bg-white p-6 shadow-sm dark:bg-zinc-900">
                    <header className="mb-8">
                        ...
                        <p className="text-sm text-muted-foreground">Jouw bevestigde klusjes deze maand</p>
                    </header>
                            ...
                            return (
                                <div key={i} className="flex justify-center py-2">
                                    ...
                                    <div className={`
                                        ...
                                        ${isToday ? 'bg-blue-500 text-white shadow-lg scale-110' : ''}
                                        ${hasJob ? 'border-2 border-orange-400 bg-orange-50 text-orange-600' : 'text-foreground hover:bg-zinc-100'}
                                    `}>
                                        {day}
                                    </div>
                                </div>
